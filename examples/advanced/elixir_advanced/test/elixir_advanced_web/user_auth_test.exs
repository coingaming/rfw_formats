defmodule ElixirAdvancedWeb.UserAuthTest do
  use ElixirAdvancedWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias ElixirAdvanced.Account
  alias ElixirAdvancedWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ElixirAdvancedWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ElixirAdvancedWeb.Endpoint.subscribe(live_socket_id)
