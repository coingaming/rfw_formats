defmodule ElixirAdvanced.AccountTest do
  use ElixirAdvanced.DataCase

  alias ElixirAdvanced.Account

  import ElixirAdvanced.AccountFixtures
  alias ElixirAdvanced.Account.{User, UserToken}
  ...
  describe "create_user_api_token/1 and fetch_user_by_api_token/1" do
    test "creates and fetches by token" do
      ...
      assert Account.fetch_user_by_api_token(token) == {:ok, user}
      assert Account.fetch_user_by_api_token("invalid") == :error
    end
  end
end
